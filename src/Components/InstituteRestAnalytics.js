...
export default function InstituteRestAnalytics() {
  return (
    <div>
      ...
      <div class="row h-100">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 col-12 rounded-end shadow" style={{"backgroundColor": "rgb(75, 75, 177)"}}>
                ...
                <p class="py-3"><Link to="/institutedashboard" class="text-dark text-decoration-none"><img src="data_logo.png" alt=""/><b class="ms-3 fs-6 text-light" >Data</b></Link></p>
